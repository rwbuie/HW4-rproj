...
```{r}
library(xlsx)
test <- readxl::read_xlsx("TARGET_AML_ClinicalData_20160714.xlsx", 1)
...
These data were acquired during a recent biomics hackathon at fred hutch. It is the clinical characteristics from the  adult leukemia subset of the openly available data from the TARGET study. 
